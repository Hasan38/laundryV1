...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Daftar Paket | <?php include "title.php" ?></title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Daftar Paket <small><a href="paket_add.php">Tambah Paket Baru</a></small></h1>
          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li>Paket</li>
            <li class="active"><a href="paket_list.php">Daftar Paket</a></li>
          </ol>
        </section>

        <section class="content">
          <?php include "paket_list_data.php" ?>
        </section>
      </div>
